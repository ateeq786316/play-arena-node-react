...
disputeRoutes.get("/all", authMiddleware, requireAdmin, asyncHandler(controller.getAllDisputes.bind(controller)));
...
disputeRoutes.patch("/:id/resolve", authMiddleware, requireAdmin, asyncHandler(controller.resolveDispute.bind(controller)));
