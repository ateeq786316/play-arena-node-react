...
- [x] Admin finance — Returns platform-wide summary (totalBookings, totalPayments, totalGrounds)
...
- [x] Get user detail — Returns user with counts
- [x] Get grounds — Paginated with owner + counts
- [x] Verify ground — Updates + creates audit log
- [x] Suspend ground — Updates + creates audit log
- [x] Get teams — Paginated with captain + member counts
- [x] Get finance — Platform-wide aggregates
- [x] Get audit logs — Paginated list
...
| 2026-07-29 | Finance — All endpoints | 15 | 15 | 0 | Payment methods, cash sessions (open/close/variance), ground finance, reports, admin finance |
...
| 2026-08-03 | Disputes — All endpoints | 10 | 10 | 0 | File, my disputes, get dispute, get all disputes, resolve (with no-show penalty), damage claim |
...
| `tests/finance.test.js` | Unit (mocked DB) | Payment methods, ground finance, cash sessions (open/close/variance), reports, admin finance |
...
| `tests/dispute.test.js` | Unit (mocked DB) | File, my disputes, get dispute, get all disputes, resolve (with no-show penalty), damage claim |

---

## Coverage Goals

- Unit test coverage (current): Auth 100%, Ground 100%, Booking 100%, Team 100%, Matchmaking 100%, Tournaments 100%, Finance 100%, Disputes 100%
